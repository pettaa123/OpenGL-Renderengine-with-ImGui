...
namespace MarkerLib {
	...
	public:
		...
		int refineCorner(const BaseLib::STBimage& stbImage, float* pointX, float* pointY, int32_t winSize=5, int32_t zeroZone=-1, int32_t maxIterations=1000, double epsilon=0.001);
